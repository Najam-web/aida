                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row g-md-5 g-4">
                                            ...
                                            <div class="col-md-6">
                                                <?php echo do_shortcode('[cms_login]'); ?>

                                         <div class="info_div">
                                                    <h5>Please contact Admin, If can't login.</h5>
                                                    <ul>
                                                        <li>
                                                            Email : info@aida-india.org</li>
                                                        <!--<li> Tel : +91 - 9999998888</li>-->
                                                    </ul>
                                                </div>
                                        </div>
                                        <div class="col-md-6">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/committees/login.webp" alt="login.webp">
                                        </div>
