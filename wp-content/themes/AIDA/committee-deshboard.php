<?php
   /**
   * Template Name: Committee Deshboard
   */
   ?>
    <?php get_header(); ?>
                            ...
                            <ul>
                                <li>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php echo esc_url(site_url('/'))?>meetings/" class="active"> Upcoming meeting <img src="<?php echo get_template_directory_uri(); ?>/images/about/arrow-right.svg" alt="tab4"></a>
                                        </li>
                                        <li>
...
<ul class="breadcrumb">
    ...
    ?>
                ...
                <div class="container-fluid sec-padd">
                    <div class="col-md-12">
                        <h2 class="heading-c after-border mb-5 aos-init" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">Upcoming meeting</h2>
                    </div>
                    <div class="row pb-4  g-4">
                        <div class="col-md-12">
                          <?php echo do_shortcode('[cms_meetings]'); ?>
                        </div>
                    </div>
                    <?php
