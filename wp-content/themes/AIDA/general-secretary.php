...
/**
 * Template Name: General Secretary
 */
?>
<?php get_header(); ?>
<section class="about_sec">
                ...
                <ul class="group_option">
                    ...
                    <li><a href="<?php echo esc_url(site_url('/organizational-structure')) ?>">Organizational Structure <img src="<?php echo get_template_directory_uri(); ?>/images/about/right.svg" alt="icon"></a>
                        <ul>
                            ...
                            <li>
                                <a class="active" href="<?php echo esc_url(site_url('/')) ?>key-people-category/general-secretary/">Secretariat <img src="<?php echo get_template_directory_uri(); ?>/images/about/arrow-right.svg" alt="General Secretary"></a>
                            </li>
        ...
        <div class="col-md-9">
            ...
            <div class="container-fluid sec-padd profile_sec">
                <div class="col-md-12">
                    ...
                    <!-- <p class="mb-5">Elected from among the Executive Council for a term of 3 years</p> -->
                </div>
                <div>
    ...
    'posts_per_page' => -1,
    'orderby'        => 'date', // 👈 Order by post publish date/time
    'order'          => 'ASC',// 👈 Newest first (use 'ASC' for oldest first
    'tax_query'      => array(
        array(
            'taxonomy' => 'organizational_category',
            'field'    => 'slug',
            'terms'    => 'general-secretary',
        ),
    ),
);
