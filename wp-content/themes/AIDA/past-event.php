                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a href="<?php echo esc_url(site_url('/'))?>past-events/"  class="active">Past Events <img
                    ...
                    <div class="row g-md-5 g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <h2 class="heading-c after-border mb-4 aos-init aos-animate" data-aos="fade-up"
                                ...
                                data-aos-anchor-placement="top-bottom" data-aos-duration="2000"> Past events
...
$past_args = array(
    ...
    'meta_query'     => array(
        ...
        array(
            ...
            // Past if no end_date and start_date < (today - 6 days)
            array(
                'key'     => 'start_date',
                'value'   => date('Ymd', strtotime('-6 days')),
                'compare' => '<',
...
if ($past_events->have_posts()) :
    ...
    if ($cat_name === 'AIDA Hosted') : ?>
        <span class="event-type">AIDA Hosted</span>
    <?php elseif ($cat_name === 'AIDA Participating') : ?>
        <span class="event-type">AIDA Participated</span>
    <?php else : ?>
        <span class="event-type"><?php echo esc_html($cat_name); ?></span>
    <?php endif; ?>
<?php endif; ?>
